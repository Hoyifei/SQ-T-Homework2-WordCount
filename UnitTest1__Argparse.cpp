...
TEST(TestMethod2,UnitTest1){
    ...
    GENERATE_ARG(arg1,"-q");
    argv[1]=arg1;
    GENERATE_ARG(arg2,"./unittest1_testinputs/input.txt");
    argv[2]=arg2;
    int argc=3;
    CWordCount test;
...
TEST(TestMethod3,UnitTest1){
    ...
    GENERATE_ARG(arg2,"-c");
    argv[2]=arg2;
    GENERATE_ARG(arg3,"./unittest1_testinputs/input.txt");
    argv[3]=arg3;
    int argc=4;
    CWordCount test;
    EXPECT_EQ(test.entrance(argc,argv),1);
...
TEST(TestMethod5,UnitTest1){
    ...
    GENERATE_ARG(arg3,"-o");
    argv[3]=arg3;
    GENERATE_ARG(arg4,"./unittest1_testinputs/output.txt");
    argv[4]=arg4;
    GENERATE_ARG(arg5,"-c");
    argv[5]=arg5;
    int argc=6;
...
TEST(TestMethod7,UnitTest1){
    ...
    GENERATE_ARG(arg3,"-l");
    argv[3]=arg3;
    GENERATE_ARG(arg4,"./unittest1_testinputs/example.txt");
    argv[4]=arg4;
    int argc=5;
    CWordCount test;
    EXPECT_EQ(test.entrance(argc,argv),6);
...
TEST(TestMethod8,UnitTest1){
    ...
    GENERATE_ARG(arg3,"-l");
    argv[3]=arg3;
    GENERATE_ARG(arg4,"./unittest1_testinputs/input.txt");
    argv[4]=arg4;
    int argc=5;
    CWordCount test;
...
TEST(TestMethod9,UnitTest1){
    ...
    GENERATE_ARG(arg5,"-o");
    argv[5]=arg5;
    GENERATE_ARG(arg6,"./unittest1_testinputs/output.txt");
    argv[6]=arg6;
    int argc=7;
    CWordCount test;
    EXPECT_EQ(test.entrance(argc,argv),0);
